...
public class RangedWeaponItem : ItemObject
{
    ...
    public override bool UseItem() {
        ...
        for (int i = 0; i < numProjectiles; i++) {
            GameObject projectile = Instantiate(laser, new Vector3(playerPos.position.x, playerPos.position.y + 1.25f, playerPos.position.z), Quaternion.Euler(-90, playerPos.eulerAngles.y, 0));
